<template>
	<div class="mp-main-container">
		<el-row type="flex" class="mp-first-row">
			...
			<el-col :xs="12" :sm="12" :md="12" :lg="12" :xl="12">
				<shared-diary-list :diaries.sync="diaries" />
			</el-col>
		</el-row>
...
export default {
	...
	async mounted() {
		try {
			...
			let data = await this.diaryByNickname(this.user.nickname);
	...
	methods: {
		...
		...mapActions("sharedDiaryList", {diaryByNickname: "searchByNickname"})
	},
};
</script>
